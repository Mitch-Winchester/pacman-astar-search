...
class MazeBase(object):
    def __init__(self):
        self.portalPairs = []
        self.homeoffset = (0,0)
        self.ghostNodeDeny = {constants.UP:(), constants.DOWN:(), constants.LEFT:(), constants.RIGHT:()}
    ...
    def connectHomeNodes(self, nodes):
        ...
        nodes.connectHomeNodes(key, self.homenodeconnectLeft, constants.LEFT)
        nodes.connectHomeNodes(key, self.homenodeconnectRight, constants.RIGHT)
    
    def addOffset(self, x, y):
        return x+self.homeoffset[0], y+self.homeoffset[1]
    
    def denyGhostsAccess(self, ghosts, nodes):
        nodes.denyAccessList(*(self.addOffset(2, 3) + (constants.LEFT, ghosts)))
        nodes.denyAccessList(*(self.addOffset(2, 3) + (constants.RIGHT, ghosts)))
...
class Maze1(MazeBase):
    def __init__(self):
        ...
        self.ghostNodeDeny = {constants.UP:((12, 14), (15, 14), (12, 26),  (15, 26)),
                              constants.LEFT:(self.addOffset(2, 3),),
                              constants.RIGHT:(self.addOffset(2, 3),)}
...
class Maze2(MazeBase):
    def __init__(self):
        ...
        self.ghostNodeDeny = {constants.UP:((9, 14), (18, 14), (11, 23), (16, 23)), constants.LEFT:(self.addOffset(2, 3),),
                              constants.RIGHT:(self.addOffset(2, 3),)}
